  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm bg-white border shadow-sm rounded-2xl p-6 text-center">
        ...
        <h1 className="text-2xl font-semibold text-gray-900mb-6">CondoPay</h1>
...
=======
      ...
      <button
        onClick={handleLogin}
        className="w-full rounded-xl bg-blue-600 text-white py-2 hover:bg-blue-700 transition"
      >
        Log In
      </button>
      <button className="block mx-auto mt-3 text-xs text-gray-500 hover:underline">
        Forgot password?
      </button>
